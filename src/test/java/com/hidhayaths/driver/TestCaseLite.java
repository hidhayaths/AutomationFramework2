...
import com.hidhayaths.framework.selenium.ResultSummaryManager;
 ...
 * @author hidhayaths
 */
public abstract class TestCaseLite {
	...
	/**
	 * The {@link AutomationDriver} object (passed from the Driver script)
	 */
